...
interface CheckboxGroupProps {
    ...
    onChange: (active: (number | string)[], event: React.ChangeEvent<HTMLInputElement>) => void;
    id: string;
    inline?: boolean;
}

const CheckboxGroup: React.FC<CheckboxGroupProps> = ({ options, active: initialActive, onChange, id, inline = false }) => {
